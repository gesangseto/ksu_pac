    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= site_url('Permission/Update') ?>" method="POST">
            <div class="row">
              <div class="col-md-12">
...
<div class="modal" id="create_permission">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= site_url('Permission/Create') ?>" method="POST">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <input type="text" name="user_id" hidden value="<?= $user_info[0]['id'] ?>">
...
<script>
  function hapus(uid) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          window.location.href = "<?= site_url('Permission/Delete?role_id='); ?>" + uid + "&&user_id=<?= $user_info[0]['id'] ?>";
        } else {
          swal("User is safe!");
        }
      });
