                    ...
                    <div class="col-md-12">
                        <table id="example" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                $working_day = 0;
                                if (isset($all_pending_approval['status'])) { } else {
                                    foreach ($all_pending_approval as $row) {
                                        ...
                                        echo '<a href="' . site_url('Payroll_Approval/Read') . '?sdm_id=' . @$row['sdm_id'] . '&project_id=' . @$row['project_id'] . '&week=' . @$row['week'] . '" class="btn btn-success"><i class="fa fa-search"></i></a>';
                                        echo '</td>';
                                        echo '</tr>';
                                        $no++;
                                    }
