                                ...
                                foreach ($all_sdm as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('User_Sdm/Update') ?>?id=<?= $row['id'] ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                            <a href="<?= site_url('User_Sdm/Read') ?>?id=<?= $row['id'] ?>" class="btn btn-success"><i class="fa fa-search"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                    $no++;
