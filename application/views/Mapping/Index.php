                                            ...
                                            <table id="example2" class="table table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($access_map as $row_access) {
                                                        ...
                                                        if ($count != 0) {
                                                            echo '<a href="' . site_url('Mapping/Read') . '?id=' . $row_access['id'] . '" class="btn btn-success"><i class="fa fa-search"></i></a>';
                                                        }
                                                        echo '</td>';
                                                        echo '</tr>';
                                                        $no++;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= site_url('Mapping/Update') ?>" method="POST">
                        <div class="row">
                            <div class="col-md-12">
...
<div class="modal" id="new_parent_map">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('Mapping/Create') ?>" method="POST">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="inputWarning2" class="control-label">Parent Name</label>
...
<script>
    function hapus_parent(uid) {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location.href = "<?= site_url('Mapping/Delete?parent_map_id='); ?>" + uid;
                } else {
                    swal("Map is safe!");
                }
            });
    ...
    function hapus_access(id) {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location.href = "<?= site_url('Mapping/Delete?access_map_id='); ?>" + id;
                } else {
                    swal("Map is safe!");
                }
            });
