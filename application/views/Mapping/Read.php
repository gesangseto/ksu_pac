              ...
              <tbody>
                ...
                foreach ($access_map as $row) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= site_url('Mapping/Delete') ?>?admin_id=<?= $row['admin_id'] ?>&map_id=<?= $row['access_map_id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
...
<script>
  function hapus(uid) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          window.location.href = "<?= site_url('Mapping/Delete?id_user='); ?>" + uid;
        } else {
          swal("User is safe!");
        }
      });
